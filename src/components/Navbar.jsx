...
export default function Navbar(){
    ...
    return(
        <>
        <div className="box-border w-screen font-custom  flex z-[999] sticky top-0 justify-between  items-center p-5 h-[72px] bg-red-500 xl:px-24 2xl:px-40 2xl:text-2xl shadow-md md:shadow-none lg:px-16">
            <div>
